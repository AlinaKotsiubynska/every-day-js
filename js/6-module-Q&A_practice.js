...
*/
const prices = [30, 82, 49, 25, 7, 65, 532, 104]
const sortByAscendingPrices = prices => [...prices].sort();
const sortedByDescentingPrices = prices => [...prices].sort((a, b) => b - a); // [...prices].sort().reverce()
